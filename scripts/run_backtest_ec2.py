...
print(f"\n{'='*60}")
print(f"SENSEX   net: {s_total:.1f} pts  (lot=20, 2lots=40)  Rs {s_total*40:.0f}")
print(f"CRUDEOIL net: {c_total:.1f} pts  (lot=100, 2lots=200)  Rs {c_total*200:.0f}")
print(f"COMBINED P&L: Rs {s_total*40 + c_total*200:.0f}")
